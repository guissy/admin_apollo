...
const { cmsLog } = mockjs.mock({'cmsLog|20': [{
  'id|+1': 1,
  user_name: '@cname',
  ip: '@ip',
  module: '@city',
...
const { currencySetting } = mockjs.mock({'currencySetting|5': [{
  'id|+1': 1,
  cytype: '@city',
  ctype: '@city',
...
const { memberLog } = mockjs.mock({'memberLog|5': [{
  'id|+1': 1,
  id: '@city',
  name: '@cname',
  domain: '@url',
...
const { gameAccount } = mockjs.mock({'gameAccount|5': [{
  'id|+1': 1,
  partner_name: '@city',
  admin_url: '@url',
  admin_account: '@first',
...
const { emailManage } = mockjs.mock({'emailManage|5': [{
  'id|+1': 1,
  title: '@city',
  'send_type|1-3': 1,
  'status|1': ["enabled","disabled"],
...
const { domainSetting } = mockjs.mock({'domainSetting|5': [{
  'id|+1': 1,
  name: '@city',
  title: '@city',
  bottom: '@city',
