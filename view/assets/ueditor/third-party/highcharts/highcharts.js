...
(function() {
  ...
  function Eb(a, b, c, d) {
    ...
    if (u(b)) {
      ...
      h = i[ab]();
      for (
        var d = i.getTime(), l = i[$a](), m = i[Sa](), p = g ? 0 : (864e5 + i.getTimezoneOffset() * 6e4) % 864e5;
        d < c;
        ...
        e.push(d),
          j === D[Da]
            ...
            : j === D[Ra]
              ? (d = bb(h, l + b * k))
              : !g && (j === D[ua] || j === D[Za]) ? (d = bb(h, l, m + b * k * (j === D[ua] ? 1 : 7))) : (d += j * k),
          b++;
      e.push(d);
      n(
        ub(e, function(a) {
  ...
  wa.prototype = {
    ...
    attr: function(a, b) {
      ...
      if (ea(a))
        (c = a),
          h === 'circle' ? (c = { x: 'cx', y: 'cy' }[c] || c) : c === 'strokeWidth' && (c = 'stroke-width'),
          (q = v(g, c) || this[c] || 0),
        ...
        for (c in a)
          if (((j = !1), (d = a[c]), (e = k[c] && k[c].call(this, d, c)), e !== !1)) {
            ...
            if (c === 'd') d && d.join && (d = d.join(' ')), /(NaN| {2}|^$)/.test(d) && (d = 'M 0 0');
              ...
              for (e = 0; e < g.childNodes.length; e++) (f = g.childNodes[e]), v(f, 'x') === v(g, 'x') && v(f, 'x', d);
            ...
            if (l && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(c))
              for (e = l.length; e--; ) v(l[e], c, c === 'height' ? s(d - (l[e].cutHeight || 0), 0) : d);
    ...
    setSpanRotation: function(a) {
      var b = {};
      b[
        ta ? '-ms-transform' : gb ? '-webkit-transform' : hb ? 'MozTransform' : Nb ? '-o-transform' : ''
  ...
  Ha.prototype = {
            ...
            if (
              ...
              !o &&
                ...
                v(
                  n,
                  'dy',
                  l || c.fontMetrics(/px$/.test(n.style.fontSize) ? n.style.fontSize : j.fontSize).h,
                  gb && n.offsetHeight
                )),
              b.appendChild(n),
              o++,
    ...
    html: function(a, b, c) {
      ...
      e
        .attr({ text: a, x: t(b), y: t(c) })
        .css({ position: 'absolute', whiteSpace: 'nowrap', fontFamily: d.fontFamily, fontSize: d.fontSize });
      e.css = e.htmlCss;
      if (h.isSVG)
        e.add = function(a) {
          var b,
      ...
      function j() {
        ...
        if (C) {
          if (!A)
            (a = t(-s * da)),
              (b = h ? -v : 0),
              (q.box = A = d ? p.symbol(d, a, b, q.width, q.height) : p.rect(a, b, q.width, q.height, 0, lb[Rb])),
              A.add(q);
      ...
      return r(q, {
        css: function(a) {
          if (a) {
            var b = {},
              a = x(a);
            n('fontSize,fontWeight,fontFamily,color,lineHeight,width,textDecoration,textShadow'.split(','), function(
              c
            ) {
          ...
          for (c in a)
            if (((d = a[c]), (m = !1), (e = p[c] && p[c].call(this, d, c)), e !== !1 && d !== null)) {
              ...
              if (j && /^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c))
                ...
                h === 'DIV' &&
                  ((d = d === 'hidden' ? '-999em' : 0), fb || (g[c] = d ? 'visible' : 'hidden'), (c = 'top'));
                g[c] = d;
                m = !0;
                ...
                ((f.getElementsByTagName('stroke')[0] || U(i.prepVML(['<stroke/>']), null, null, f))[c] = d || 'solid'),
                  (this.dashstyle = d),
                  (m = !0);
              else if (c === 'fill')
                if (h === 'SPAN') g.color = d;
        ...
        return r(e, {
          ...
          getCSS: function(a) {
            var b = a.element,
              ...
              d = {
                clip:
                  'rect(' + t(a ? e : d) + 'px,' + t(a ? f : b) + 'px,' + t(a ? b : f) + 'px,' + t(a ? d : e) + 'px)'
              };
    ...
    getPosition: function(a, b, c, d) {
      ...
      return {
        x: a
          ...
          : e.left + e.offset + (e.opposite ? ((d && f.oldChartWidth) || f.chartWidth) - e.right - e.left : 0),
  ...
  db.prototype = {
    ...
    defaultLabelFormatter: function() {
      ...
      if (h) g = Ca(h, this);
        ...
        for (; f-- && g === w; ) (c = Math.pow(1e3, f + 1)), a >= c && e[f] !== null && (g = Aa(b / c, -1) + e[f]);
    ...
    getLogTickPositions: function(a, b, c, d) {
      ...
      if (a >= 0.5) (a = t(a)), (g = this.getLinearTickPositions(a, b, c));
        ...
        (a = o(
          ...
          (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)
        )),
        (a = ob(a, null, nb(a))),
    ...
    zoom: function(a, b) {
      this.allowZoomOutside ||
        (u(this.dataMin) && a <= this.dataMin && (a = w), u(this.dataMax) && b >= this.dataMax && (b = w));
  ...
  wb.prototype = {
    ...
    getAnchor: function(a, b) {
      ...
      this.followPointer &&
        b &&
        (b.chartX === w && (b = d.pointer.normalize(b)), (c = [b.chartX - d.plotLeft, b.chartY - f]));
      c ||
        (n(a, function(a) {
          i = a.series.yAxis;
          g += a.plotX;
      ...
      if (
        ...
        if (this.graphic)
          (e = f && this.graphic.symbolName && m[a].r),
            this.graphic.attr(x(m[a], e ? { x: b - e, y: c - e, width: 2 * e, height: 2 * e } : {}));
        else {
          if (a && h)
            (e = h.radius),
              (k = k.symbol || d.symbol),
  ...
  Q.prototype = {
      ...
      for (m = 0; m < g; m++)
        (i = h + m),
          j
            ...
            : (b[i] ? (k = b[i]) : a[i] !== w && (b[i] = k = new f().init(this, a[i], d[m])), (l[m] = k));
      if (b && (g !== (c = b.length) || j))
        for (m = 0; m < c; m++) if ((m === h && !j && (m += g), b[m])) b[m].destroyElements(), (b[m].plotX = w);
      this.data = b;
      this.points = l;
    },
    ...
    getExtremes: function() {
      ...
      for (l = 0; l < d; l++)
        if (
          ...
          (j = this.getExtremesFromAll || this.cropped || ((b[l + 1] || j) >= h && (b[l - 1] || j) <= g)),
          i && j)
        )
      ...
      if (this.options.enableMouseTracking !== !1) {
        ...
        for (i = 0; i < a; i++)
          if (((e = b[i]), (c = e.x), c >= f.min && c <= f.max)) {
            ...
            c = d === w ? 0 : d + 1;
            for (
              d = b[i + 1] ? I(s(0, P((e.clientX + (h ? h.wrappedClientX || h.clientX : g)) / 2)), g) : g;
              c >= 0 && c <= d;
    ...
    destroy: function() {
      ...
      n('area,graph,dataLabelsGroup,group,markerGroup,tracker,graphNeg,areaNeg,posClip,negClip'.split(','), function(
        b
      ) {
          ...
          c.rotation
            ...
            : (b.align(c, null, d),
              ...
              o(c.overflow, 'justify') === 'justify'
                ...
                : o(c.crop, !0) && (a = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + j.width, g.y + j.height)));
      a || b.attr({ y: -999 });
    },
        ...
        b.getPointSpline
          ...
          : (c.push(f ? 'L' : 'M'),
            d &&
              ...
              d === 'right'
                ? c.push(i.plotX, h)
                : d === 'center' ? c.push((i.plotX + g) / 2, i.plotY, (i.plotX + g) / 2, h) : c.push(g, i.plotY)),
  ...
  F = ha(Q, {
      ...
      b.grouping === !1
        ...
        : n(a.chart.series, function(b) {
            ...
            if (b.type === a.type && b.visible && d.len === e.len && d.pos === e.pos)
              c.stacking ? ((f = b.stackKey), g[f] === w && (g[f] = i++), (h = g[f])) : c.grouping !== !1 && (h = i++),
                (b.columnIndex = h);
          });
    ...
    alignDataLabel: function(a, b, c, d, e) {
      ...
      if (
        ...
        ((d = x(h)),
        g &&
          (d = { x: f.plotWidth - d.y - d.height, y: f.plotHeight - d.x - d.width, width: d.height, height: d.width }),
        !j)
      )
        ...
        for (H = 2; H--; ) {
          ...
          for (B = 0; B < J; B++) {
            ...
            if (this.options.size === null)
              (w = r.width),
                y - w < f ? (D[3] = s(t(w - y + f), D[3])) : y + w > h - f && (D[1] = s(t(y + w - h + f), D[1])),
                z - x / 2 < 0 ? (D[0] = s(t(-z + x / 2), D[0])) : z + x / 2 > d && (D[2] = s(t(z + x / 2 - d), D[2]));
          }
        }
