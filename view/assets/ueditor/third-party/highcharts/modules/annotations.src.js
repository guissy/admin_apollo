(function(Highcharts, HighchartsAdapter) {
  ...
  Annotation.prototype = {
    ...
    redraw: function() {
      ...
      if (linkedTo) {
        linkType =
          linkedTo instanceof Highcharts.Point ? 'point' : linkedTo instanceof Highcharts.Series ? 'series' : null;
      ...
      x = defined(options.xValue)
        ? xAxis.toPixels(options.xValue + xAxis.minPointOffset) - xAxis.minPixelPadding
        : options.x;
