    ...
    mapZoom: function(a, b, c) {
      if (!this.isMapZooming) {
        ...
        b = d.fitToBox(
          ...
          { x: e.dataMin, y: f.dataMin, width: e.dataMax - e.dataMin, height: f.dataMax - f.dataMin }
        );
  ...
  k.map = g.extendClass(k.scatter, {
    ...
    init: function(a) {
      ...
      if ((h = b.options.valueRanges))
        ...
        (f = j.from),
          ...
          (m = o ? [0, 0, 1, 0] : [0, 1, 0, 0]),
          o || ((o = h), (h = j), (j = o)),
          (o = { linearGradient: { x1: m[0], y1: m[1], x2: m[2], y2: m[3] }, stops: [[0, f], [1, i]] }),
          (d = [
            {
              chart: b.chart,
              options: {},
    ...
    drawLegendSymbolGradient: function(a, b) {
      ...
      h
        ...
        : ((a.offsetWidth = Math.max(f.width, e.width) + c + j.width + d), (a.itemY = j.height + d), (a.itemX = c));
    },
    getBox: function(a) {
    ...
    translatePath: function(a) {
      ...
      for (e = a.length; e--; )
        typeof a[e] === 'number' &&
          ((a[e] = b ? Math.round(c.translate(a[e])) : Math.round(d.len - d.translate(a[e]))), (b = !b));
      return a;
    },
    setData: function() {
