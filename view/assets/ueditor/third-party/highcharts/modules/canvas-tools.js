  ...
  function m() {
      ...
      this.Definition = {
        ...
        getFillStyle: function(b) {
          ...
          return d != null && d.createGradient
            ...
            : d != null && d.createPattern ? d.createPattern(a.ctx, b) : null;
        }
      };
      this.Length = {
        DPI: function() {
                    ...
                    : c.match(/cm$/)
                      ...
                      : c.match(/mm$/)
                        ...
                        : c.match(/in$/)
                          ...
                          : c.match(/%$/) ? b.numValue() * a.ViewPort.ComputeSize(d) : b.numValue();
        }
      };
      this.Time = {
        ...
        toRadians: function() {
          ...
          return a.match(/deg$/)
            ...
            : a.match(/grad$/)
              ...
              : a.match(/rad$/) ? b.numValue() : b.numValue() * (Math.PI / 180);
        }
      };
    };
    a.Font = new function() {
      ...
      this.Parse = function(d) {
        for (
          var b = {}, d = a.trim(a.compressSpaces(d || '')).split(' '), k = !1, e = !1, f = !1, g = !1, j = '', h = 0;
          h < d.length;
          h++
        )
        ...
        if (this.style('display').value != 'none' && this.attribute('visibility').value != 'hidden') {
          ...
          if (this.attribute('mask').hasValue()) {
            ...
            this.style('filter').hasValue()
              ? ((a = this.style('filter').Definition.getDefinition()), a != null && a.apply(b, this))
      ...
      if (c != null && c.nodeType == 1) {
        ...
        if (this.attribute('style').hasValue()) {
          ...
          for (d = 0; d < b.length; d++)
            a.trim(b[d]) != '' &&
              ((c = b[d].split(':')), (k = a.trim(c[0])), (c = a.trim(c[1])), (this.styles[k] = new a.Property(k, c)));
        }
    ...
    a.Element.svg = function(c) {
      ...
      this.setContext = function(d) {
        ...
        this.attribute('x').hasValue() &&
          ...
          d.translate(this.attribute('x').Length.toPixels('x'), this.attribute('y').Length.toPixels('y'));
        ...
        if (
          ...
          this.attribute('refX').hasValue() &&
            ...
            ((e = -this.attribute('refX').Length.toPixels('x')), (f = -this.attribute('refY').Length.toPixels('y')));
          d.beginPath();
          d.moveTo(e, f);
          d.lineTo(b, f);
          d.lineTo(b, c);
    ...
    a.Element.line = function(c) {
      ...
      this.getPoints = function() {
        return [
          new a.Point(this.attribute('x1').Length.toPixels('x'), this.attribute('y1').Length.toPixels('y')),
          new a.Point(this.attribute('x2').Length.toPixels('x'), this.attribute('y2').Length.toPixels('y'))
        ];
      };
      this.path = function(d) {
    ...
    a.Element.path = function(c) {
      ...
      this.PathParser = new function(d) {
        ...
        this.getReflectedControlPoint = function() {
          return this.previousCommand.toLowerCase() != 'c' && this.previousCommand.toLowerCase() != 's'
            ? this.current
      ...
      this.path = function(d) {
        ...
        for (d != null && d.beginPath(); !b.isEnd(); )
          switch ((b.nextCommand(), b.command.toUpperCase())) {
            ...
            case 'H':
              for (; !b.isCommandOrEnd(); )
                (e = new a.Point((b.isRelativeCommand() ? b.current.x : 0) + b.getScalar(), b.current.y)),
            ...
            case 'V':
              for (; !b.isCommandOrEnd(); )
                (e = new a.Point(b.current.x, (b.isRelativeCommand() ? b.current.y : 0) + b.getScalar())),
                  b.addMarker(e, b.current),
                  (b.current = e),
                  c.addPoint(b.current.x, b.current.y),
                  d != null && d.lineTo(b.current.x, b.current.y);
      ...
      this.getMarkers = function() {
        for (
          var a = this.PathParser.getMarkerPoints(), b = this.PathParser.getMarkerAngles(), c = [], e = 0;
          e < a.length;
          e++
        )
          c.push([a[e], b[e]]);
      ...
      this.renderChildren = function(b) {
        for (
          ...
          h.attribute('x').hasValue()
            ...
            : (h.attribute('dx').hasValue() && (c += h.attribute('dx').Length.toPixels('x')), (h.x = c));
          c = h.measureText(b);
          ...
          h.attribute('y').hasValue()
            ...
            : (h.attribute('dy').hasValue() && (d += h.attribute('dy').Length.toPixels('y')), (h.y = d));
          d = h.y;
          h.render(b);
        }
      };
      ...
      this.renderChildren = function(b) {
        if (this.hasText) {
          ...
          a.Mouse.checkBoundingBox(
            this,
            new a.BoundingBox(this.x, this.y - c.Length.toPixels('y'), this.x + this.measureText(b), this.y)
          );
    ...
    a.Element.style = function(c) {
      ...
      this.base(c);
      for (
        var c = c.childNodes[0].nodeValue + (c.childNodes.length > 1 ? c.childNodes[1].nodeValue : ''),
          c = c.replace(/(\/\*([^*]|[\r\n]|(\*+([^*\/]|[\r\n])))*\*+\/)|(^[\s]*\/\/.*)/gm, ''),
          c = a.compressSpaces(c),
          c = c.split('}'),
          d = 0;
        ...
        for (var j = 0; j < g; j++)
          for (var h = 0; h < f; h++)
            for (var l = a[j * f * 4 + h * 4 + 3] / 255, o = 0; o < 4; o++) {
              for (
                var n = d[0] * (l == 0 ? 255 : a[j * f * 4 + h * 4 + o]) * (l == 0 || o == 3 ? 1 : l), q = 1;
                q < d.length;
                q++
              ) {
    ...
    a.loadXmlDoc = function(c, d) {
      ...
      var k = a.CreateElement(d.documentElement),
        ...
        f = function() {
          a.ViewPort.Clear();
          c.canvas.parentNode &&
            a.ViewPort.SetCurrent(c.canvas.parentNode.clientWidth, c.canvas.parentNode.clientHeight);
    ...
    if (a == null && c == null && d == null)
      ...
      (d = d || {}),
        ...
        typeof c.documentElement != 'undefined'
          ? b.loadXmlDoc(a, c)
          : c.substr(0, 1) == '<' ? b.loadXml(a, c) : b.load(a, c);
  };
})();
