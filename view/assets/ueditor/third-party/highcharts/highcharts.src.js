...
(function() {
    ...
    for (key in replacements) {
      while (format.indexOf('%' + key) !== -1) {
        ...
        format = format.replace(
          '%' + key,
          typeof replacements[key] === 'function' ? replacements[key](timestamp) : replacements[key]
        );
      }
    }
    ...
    setSpanRotation: function(rotation) {
      var rotationStyle = {},
        cssTransformKey = isIE
          ? '-ms-transform'
          : isWebKit ? '-webkit-transform' : isFirefox ? 'MozTransform' : isOpera ? '-o-transform' : '';
            ...
            if (span !== ' ') {
              ...
              if (!spanNo && lineNo) {
                ...
                attr(
                  ...
                  'dy',
                  textLineHeight ||
                    renderer.fontMetrics(/px$/.test(tspan.style.fontSize) ? tspan.style.fontSize : textStyles.fontSize)
                      .h,
      ...
      return extend(wrapper, {
        ...
        css: function(styles) {
          if (styles) {
            ...
            each(
              ['fontSize', 'fontWeight', 'fontFamily', 'color', 'lineHeight', 'width', 'textDecoration', 'textShadow'],
              function(prop) {
  ...
  Tick.prototype = {
    ...
    addLabel: function() {
      ...
      if (axis.isDatetimeAxis && tickPositionInfo) {
        dateTimeLabelFormat =
          options.dateTimeLabelFormats[tickPositionInfo.higherRanks[pos] || tickPositionInfo.unitName];
      }
    ...
    handleOverflow: function(index, xy) {
      ...
      if (isFirst || isLast) {
        var sides = this.getLabelSides(),
          ...
          neighbourEdge =
            neighbour && neighbour.label.xy && neighbour.label.xy.x + neighbour.getLabelSides()[isFirst ? 0 : 1];
    ...
    getPosition: function(horiz, pos, tickmarkOffset, old) {
      ...
      return {
        x: horiz
          ...
          : axis.left +
            axis.offset +
            (axis.opposite ? ((old && chart.oldChartWidth) || chart.chartWidth) - axis.right - axis.left : 0),
  ...
  Axis.prototype = {
    ...
    getMinorTickPositions: function() {
      ...
      if (axis.isLog) {
        ...
        // #1314
        minorTickPositions = minorTickPositions.concat(
          getTimeTicks(normalizeTimeTickInterval(minorTickInterval), axis.min, axis.max, options.startOfWeek)
        );
    ...
    setTickPositions: function(secondPass) {
      ...
      axis.minorTickInterval =
        options.minorTickInterval === 'auto' && axis.tickInterval ? axis.tickInterval / 5 : options.minorTickInterval;
    ...
    getOffset: function() {
        ...
        if (!axis.axisTitle) {
          axis.axisTitle = renderer
            ...
            .attr({
              ...
              align:
                axisTitleOptions.textAlign || { low: 'left', middle: 'center', high: 'right' }[axisTitleOptions.align]
            })
      ...
      axis.axisTitleMargin = pick(
        titleOffsetOption,
        labelOffset + titleMargin + (side !== 2 && labelOffset && directionFactor * options.labels[horiz ? 'y' : 'x'])
      );
    ...
    removePlotBandOrLine: function(id) {
      ...
      each(
        [options.plotLines || [], userOptions.plotLines || [], options.plotBands || [], userOptions.plotBands || []],
        function(arr) {
          i = arr.length;
          while (i--) {
            if (arr[i].id === id) {
  ...
  Pointer.prototype = {
    ...
    pinch: function(e) {
      var self = this,
        ...
        fireClickEvent =
          touchesLength === 1 &&
          ((self.inClass(e.target, PREFIX + 'tracker') && chart.runTrackerClick) || chart.runChartClick),
        clip = {};
  ...
  Legend.prototype = {
    ...
    renderItem: function(item) {
      ...
      legend.offsetWidth =
        widthOption ||
        mathMax((horizontal ? legend.itemX - initialItemX - itemDistance : itemWidth) + padding, legend.offsetWidth);
    },
  ...
  Chart.prototype = {
    ...
    setTitle: function(titleOptions, subtitleOptions) {
      ...
      each([['title', titleOptions, chartTitleOptions], ['subtitle', subtitleOptions, chartSubtitleOptions]], function(
        arr
      ) {
        var name = arr[0],
          title = chart[name],
  ...
  Series.prototype = {
    ...
    drawLegendSymbol: function(legend) {
      ...
      if (markerOptions && markerOptions.enabled) {
        ...
        this.legendSymbol = legendSymbol = renderer
          .symbol(this.symbol, symbolWidth / 2 - radius, verticalCenter - radius, 2 * radius, 2 * radius)
          .add(legendItemGroup);
    ...
    getExtremes: function() {
      ...
      for (i = 0; i < yDataLength; i++) {
        ...
        withinRange =
          this.getExtremesFromAll || this.cropped || ((xData[i + 1] || x) >= xMin && (xData[i - 1] || x) <= xMax);
    ...
    drawPoints: function() {
      ...
      if (seriesMarkerOptions.enabled || series._hasPointMarkers) {
        ...
        while (i--) {
          ...
          enabled =
            (seriesMarkerOptions.enabled && pointMarkerOptions.enabled === UNDEFINED) || pointMarkerOptions.enabled;
  ...
  var ColumnSeries = extendClass(Series, {
    ...
    getColumnMetrics: function() {
      ...
      var categoryWidth = mathMin(
        ...
        pointXOffset =
          pointPadding + (groupPadding + colIndex * pointOffsetWidth - categoryWidth / 2) * (reversedXAxis ? -1 : 1);
          ...
          if (minPointLength) {
            ...
            barY = mathRound(
              mathAbs(barY - translatedThreshold) > minPointLength // stacked
                ...
                : translatedThreshold -
                  (yAxis.translate(point.y, 0, 1, 0, 1) <= translatedThreshold ? minPointLength : 0)
