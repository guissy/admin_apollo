      ...
      setAxisTranslation: function() {
        ...
        if (
          ...
          this.minPixelPadding =
            this.transA * this.minPointOffset + (this.reversed ? (this.endAngleRad - this.startAngleRad) / 4 : 0);
      },
  ...
  u = {
    ...
    translate: function() {
      ...
      s(this.points, function(d) {
        ...
        d.shapeType = 'path';
        d.shapeArgs = {
          d: g.path || ['M', -i, -n / 2, 'L', e, -n / 2, f, -l / 2, f, l / 2, e, n / 2, -i, n / 2, 'z'],
          translateX: c[0],
          translateY: c[1],
          rotation: k
        };
    ...
    processData: function(a) {
      ...
      for (j = 0; j < g; j++)
        (k = b[j]),
          ...
          k === 'sum' || d.isSum
            ? (b[j] = i)
            : k === 'intermediateSum' || d.isIntermediateSum ? ((b[j] = e), (e = f)) : ((i += k), (e += k)),
          (h = Math.min(i, h)),
          (l = Math.max(i, l));
      ...
      (s(this.series, function(b) {
        ...
        if (b.type === 'bubble' && b.visible && ((a.allowZoomOutside = !0), q.push(b), f))
          s(['minSize', 'maxSize'], function(a) {
            ...
            (b = b.zData),
            b.length &&
              ((k = t.min(k, t.max(P(b), c.displayNegative === !1 ? c.zThreshold : -Number.MAX_VALUE))),
              (m = t.max(m, Q(b))));
      }),
      s(q, function(a) {
        var b = a[e],
        ...
        if (o > 0)
          for (; c--; ) (j = a.radii[c]), (d = Math.min((b[c] - i) * p - j, d)), (g = Math.max((b[c] - i) * p + j, g));
      }),
      q.length &&
        o > 0 &&
    ...
    c.polar
      ? s(c.axes, function(a) {
          ...
          d[f ? 'xAxis' : 'yAxis'].push({
            axis: a,
            value: a.translate(f ? Math.PI - Math.atan2(h, e) : Math.sqrt(Math.pow(h, 2) + Math.pow(e, 2)), !0)
          });
        })
      : (d = a.call(this, b));
    return d;
