...
(function() {
  ...
  e.HighchartsAdapter = {
    ...
    addEvent: function(a, b, c) {
      typeof b === 'string' &&
        (b === 'unload' && (b = 'beforeunload'), e.HighchartsAdapter.extendWithEvents(a), a.addEvent(b, c));
    },
    removeEvent: function(a, b, c) {
      typeof a !== 'string' &&
        a.addEvent &&
        (b
          ? (b === 'unload' && (b = 'beforeunload'), c ? a.removeEvent(b, c) : a.removeEvents && a.removeEvents(b))
          : a.removeEvents());
    },
