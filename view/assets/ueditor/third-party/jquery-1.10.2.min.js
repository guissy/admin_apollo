...
(function(e, t) {
  ...
  (x.fn = x.prototype = {
    ...
    x.extend({
      ...
      type: function(e) {
        return null == e
          ? e + ''
          : 'object' == typeof e || 'function' == typeof e ? c[y.call(e)] || 'object' : typeof e;
      },
    ...
    (function(e, t) {
      var n,
        ...
        it = function(e, t, n) {
          ...
          return r !== r || n
            ? t
            : 0 > r ? String.fromCharCode(r + 65536) : String.fromCharCode(55296 | (r >> 10), 56320 | (1023 & r));
        };
      try {
      ...
      (s = at.isXML = function(e) {
                ...
                ? function(e, t) {
                    ...
                    return i
                      ? 1 & i || (!r.sortDetached && t.compareDocumentPosition(e) === i)
                        ? e === n || v(w, e) ? -1 : t === n || v(w, t) ? 1 : c ? F.call(c, e) - F.call(c, t) : 0
                        : 4 & i ? -1 : 1
        ...
        (at.attr = function(e, n) {
          ...
          return a === t
            ? r.attributes || !h ? e.getAttribute(n) : (a = e.getAttributeNode(n)) && a.specified ? a.value : null
            : a;
        }),
        (at.error = function(e) {
                          ...
                          : '^=' === t
                            ...
                            : '*=' === t
                              ...
                              : '$=' === t
                                ...
                                : '~=' === t
                                  ? (' ' + i + ' ').indexOf(n) > -1
                                  : '|=' === t ? i === n || i.slice(0, n.length + 1) === n + '-' : !1)
                    : !0;
              };
            },
      ...
      if (a[s]) {
        if (t && (r = n ? a[s] : a[s].data)) {
          x.isArray(t)
            ...
            : t in r ? (t = [t]) : ((t = x.camelCase(t)), (t = t in r ? [t] : t.split(' '))),
            (i = t.length);
      ...
      if (((r = e.getAttribute(i)), 'string' == typeof r)) {
        try {
          r =
            'true' === r
              ? !0
              : 'false' === r ? !1 : 'null' === r ? null : +r + '' === r ? +r : B.test(r) ? x.parseJSON(r) : r;
        } catch (o) {}
        x.data(e, n, r);
      } else r = t;
    }
        ...
        if (e && 3 !== s && 8 !== s && 2 !== s)
          return typeof e.getAttribute === i
            ...
            : ((1 === s && x.isXMLDoc(e)) ||
              ...
              r === t
                ? o && 'get' in o && null !== (a = o.get(e, n)) ? a : ((a = x.find.attr(e, n)), null == a ? t : a)
                : null !== r
                  ? o && 'set' in o && (a = o.set(e, r, n)) !== t ? a : (e.setAttribute(n, r + ''), r)
                  : (x.removeAttr(e, n), t));
      },
          ...
          while ((n = o[i++]))
            (r = x.propFix[n] || n),
              x.expr.match.bool.test(n)
                ? (K && Q) || !G.test(n) ? (e[r] = !1) : (e[x.camelCase('default-' + n)] = e[r] = !1)
                : x.attr(e, n, ''),
  ...
  x.fn.extend({
    ...
    index: function(e) {
      return e
        ? 'string' == typeof e ? x.inArray(this[0], x(e)) : x.inArray(e.jquery ? e[0] : e, this)
          ...
          2 !== b &&
            ...
            c
              ? (p.ifModified &&
                ...
                204 === e || 'HEAD' === p.type
                  ? (N = 'nocontent')
                  : 304 === e ? (N = 'notmodified') : ((N = w.state), (y = w.data), (v = w.error), (c = !v)))
      ...
      return (
        (r.duration = x.fx.off
          ...
          : 'number' == typeof r.duration
            ? r.duration
            : r.duration in x.fx.speeds ? x.fx.speeds[r.duration] : x.fx.speeds._default),
