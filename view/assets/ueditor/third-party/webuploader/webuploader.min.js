/* WebUploader 0.1.2 */ !(function(a, b) {
  var c,
    ...
    g = function(a, b, c) {
      var f,
        g = { exports: b };
      'function' == typeof b &&
        (c.length || (c = [e, g.exports, g]), (f = b.apply(null, c)), void 0 !== f && (g.exports = f)),
        (d[a] = g.exports);
    },
    h = function(b) {
      var c = d[b] || a[b];
  ...
  return (
    ...
    b('widgets/widget', ['base', 'uploader'], function(a, b) {
      function c(a) {
        ...
        return 1 === a.nodeType && b
          ? !0
          : 'array' === c ||
              ('function' !== c && 'string' !== c && (0 === b || ('number' == typeof b && b > 0 && b - 1 in a)));
      }
      function d(a) {
      ...
      return (
        ...
        (b.register = d.register = function(b, c) {
          var f,
            g = { init: 'init' };
          return (
            1 === arguments.length ? ((c = b), (c.responseMap = g)) : (c.responseMap = e.extend(g, b)),
            (f = a.inherits(d, c)),
            h.push(f),
            f
          );
    ...
    b('lib/file', ['base', 'lib/blob'], function(a, b) {
      function c(a, c) {
        ...
        b.apply(this, arguments),
          ...
          !f &&
            this.type &&
            ((f = /\/(jpg|jpeg|png|gif|bmp)$/i.exec(this.type) ? RegExp.$1.toLowerCase() : ''), (this.name += '.' + f)),
    ...
    b('widgets/queue', ['base', 'uploader', 'queue', 'file', 'lib/file', 'runtime/client', 'widgets/widget'], function(
      a,
      b,
      c,
      d,
    ...
    b('widgets/upload', ['base', 'uploader', 'file', 'lib/transport', 'widgets/widget'], function(a, b, c, d) {
      function e(a, b) {
        for (var c, d = [], e = a.source, f = e.size, g = b ? Math.ceil(f / b) : 1, h = 0, i = 0; g > i; )
          (c = Math.min(b, f - h)),
                ...
                b.runing ||
                  ...
                  f.each(b.pool, function(a, c) {
                    ...
                    d.getStatus() === h.INTERRUPT &&
                      (d.setStatus(h.PROGRESS), (b._trigged = !1), c.transport && c.transport.send());
                  }),
                  (b._trigged = !1),
      ...
      return (
        ...
        d.addValidator('fileSingleSizeLimit', function() {
          ...
          d &&
            a.on('beforeFileQueued', function(a) {
              return a.size > d
                ? (a.setStatus(c.Status.INVALID, 'exceed_size'), this.trigger('error', 'F_EXCEED_SIZE', a), !1)
                : void 0;
            });
        }),
      ...
      return b.register('DragAndDrop', {
        ...
        destroy: function() {
          ...
          a.off('dragenter', this.dragEnterHandler),
            ...
            this.options.disableGlobalDnd &&
              (d(document).off('dragover', this.dragOverHandler), d(document).off('drop', this.dropHandler));
        }
      });
    }),
    ...
    b('runtime/html5/jpegencoder', [], function() {
      function a(a) {
        function b(a) {
          ...
          for (
            var h = [1, 1.387039845, 1.306562965, 1.175875602, 1, 0.785694958, 0.5411961, 0.275899379], i = 0, j = 0;
            8 > j;
            j++
          )
            for (var k = 0; 8 > k; k++)
              (B[i] = 1 / (z[P[i]] * h[j] * h[k] * 8)), (C[i] = 1 / (A[P[i]] * h[j] * h[k] * 8)), i++;
        }
        function c(a, b) {
        ...
        function e() {
          for (var a = 1, b = 2, c = 1; 15 >= c; c++) {
            ...
            for (var e = -(b - 1); -a >= e; e++)
              (E[32767 + e] = c), (D[32767 + e] = []), (D[32767 + e][1] = c), (D[32767 + e][0] = b - 1 + e);
            (a <<= 1), (b <<= 1);
          }
        }
        function f() {
        ...
        function g(a) {
          for (var b = a[0], c = a[1] - 1; c >= 0; )
            b & (1 << c) && (I |= 1 << J), c--, J--, 0 > J && (255 == I ? (h(255), h(0)) : h(I), (J = 7), (I = 0));
        }
        function h(a) {
          H.push(N[a]);
        }
        ...
        return c.os.android
          ? ('image/jpeg' === f &&
            ...
            'image/jpeg' !== f || d
              ...
              : ((i = a.width), (j = a.height), (h = a.getContext('2d')), b.encode(h.getImageData(0, 0, i, j), g)))
          : e.apply(null, arguments);
      };
    }),
      ...
      return b.register('Image', {
        ...
        destroy: function() {
          ...
          (this._img.onload = null),
            a &&
              (a.getContext('2d').clearRect(0, 0, a.width, a.height), (a.width = a.height = 0), (this._canvas = null)),
            (this._img.src = d),
