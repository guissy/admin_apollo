...
vjs.Component = vjs.CoreObject.extend({
  ...
  init: function(player, options, ready) {
    ...
    this.id_ =
      options['id'] ||
      (options['el'] && options['el']['id'] ? options['el']['id'] : player.id() + '_component_' + vjs.guid++);
...
vjs.CurrentTimeDisplay.prototype.updateContent = function() {
  ...
  this.content.innerHTML =
    '<span class="vjs-control-text">Current Time </span>' + vjs.formatTime(time, this.player_.duration());
};
...
vjs.RemainingTimeDisplay.prototype.updateContent = function() {
  if (this.player_.duration()) {
    this.content.innerHTML =
      '<span class="vjs-control-text">Remaining Time </span>' + '-' + vjs.formatTime(this.player_.remainingTime());
  }
