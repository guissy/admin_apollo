/*! Video.js v4.3.0 Copyright 2013 Brightcove, Inc. https://github.com/videojs/video.js/blob/master/LICENSE */ (function() {
  ...
  u.kc = function(a) {
    ...
    if (!a || !a.Cb) {
      ...
      if (a.clientX != h) {
        ...
        a.pageY =
          a.clientY + ((g && g.scrollTop) || (j && j.scrollTop) || 0) - ((g && g.clientTop) || (j && j.clientTop) || 0);
      }
  ...
  u.td = function(a) {
    try {
      ...
      22 == d.code || 1014 == d.code
        ...
        : 18 == d.code ? u.log('LocalStorage not allowed (VideoJS)', d) : u.log('LocalStorage Error (VideoJS)', d);
    }
  };
  u.mc = function(a) {
  ...
  function E(a, c, d, e) {
    if (d !== b)
      return (
        (a.a.style[c] =
          -1 !== ('' + d).indexOf('%') || -1 !== ('' + d).indexOf('px') ? d : 'auto' === d ? '' : d + 'px'),
        e || a.j('resize'),
        a
      );
    if (!a.a) return 0;
  ...
  t.src = function(a) {
    if (a instanceof Array) {
      ...
      a instanceof Object
        ? window.videojs[this.ia].canPlaySource(a) ? this.src(a.src) : this.src([a])
        : ((this.v.src = a),
          this.aa
  ...
  t.controls = function(a) {
    return a !== b
      ? ((a = !!a),
        this.sb !== a &&
          ((this.sb = a)
            ? (this.u('vjs-controls-disabled'), this.n('vjs-controls-enabled'), this.j('controlsenabled'))
            : (this.u('vjs-controls-enabled'), this.n('vjs-controls-disabled'), this.j('controlsdisabled'))),
        this)
      : this.sb;
  };
  u.s.prototype.Sb;
  ...
  u.fb.prototype.Ca = function() {
    this.b.duration() &&
      (this.content.innerHTML =
        '<span class="vjs-control-text">Remaining Time </span>-' + u.La(this.b.duration() - this.b.currentTime()));
  };
  u.Ga = u.q.extend({
    i: function(a, c) {
      u.q.call(this, a, c);
  ...
  u.da.prototype.update = function() {
    ...
    this.b.muted()
      ? 'Unmute' != this.a.children[0].children[0].innerHTML && (this.a.children[0].children[0].innerHTML = 'Unmute')
      : 'Mute' != this.a.children[0].children[0].innerHTML && (this.a.children[0].children[0].innerHTML = 'Mute');
      ...
      if (this.Lb === b || a < this.Lb || this.Ma <= a) {
        ...
        for (;;) {
          ...
          if (n.va <= a) (e = Math.max(e, n.va)), n.Ia && (n.Ia = l);
            ...
            g ? (j.splice(0, 0, n), q === b && (q = r), (k = r)) : (j.push(n), k === b && (k = r), (q = r)),
              (d = Math.min(d, n.va)),
