...
!(function(a) {
  ...
  var b,
    ...
    u = function(b) {
      ...
      if (
        (b.trustedDomains &&
          ('string' == typeof b.trustedDomains
            ? (f = [b.trustedDomains])
            : 'object' == typeof b.trustedDomains && 'length' in b.trustedDomains && (f = b.trustedDomains)),
        f && f.length)
      )
      ...
      return (
        ...
        b.forceEnhancedClipboard === !0 && (g += (g ? '&' : '') + 'forceEnhancedClipboard=true'),
        g
      );
    },
    v = function(a, b, c) {
      ...
      return (
        ...
        b ||
          ('number' == typeof O.zIndex && O.zIndex > 0
            ? (b = O.zIndex)
            : 'string' == typeof O.zIndex && (c = parseInt(O.zIndex, 10)) && !isNaN(c) && c > 0 && (b = c)),
        b || 0
      );
    },
    z = function() {
    ...
    B = (function() {
      var a = function(a, b) {
        ...
        if (
          null != a &&
          '*' !== b[0] &&
          ('string' == typeof a && (a = [a]), 'object' == typeof a && 'number' == typeof a.length)
        )
    ...
    K = function() {
      ...
      if (navigator.plugins && navigator.plugins.length)
        (e = navigator.plugins['Shockwave Flash']),
          d(e),
          navigator.plugins['Shockwave Flash 2.0'] && ((h = !0), (k = '2.0.0.11'));
      else if (navigator.mimeTypes && navigator.mimeTypes.length)
        (g = navigator.mimeTypes['application/x-shockwave-flash']), (e = g && g.enabledPlugin), d(e);
      ...
      (c.disabled = h !== !0),
        ...
        (c.version = k || '0.0.0'),
        (c.pluginType = j ? 'pepper' : i ? 'activex' : h ? 'netscape' : 'unknown');
    };
  K();
  var L = function(a) {
      ...
      'number' == typeof d &&
        ...
        setTimeout(function() {
          'boolean' != typeof c.deactivated && (c.deactivated = !0),
            c.deactivated === !0 && L.emit({ type: 'error', name: 'flash-deactivated', client: b });
        }, d),
        (c.overdue = !1),
        P();
    }
  ...
  (L.isFlashUnusable = function() {
      ...
      'object' == typeof a && null !== a && z(O, a);
      {
        if ('string' != typeof a || !a) {
          ...
          for (var c in O)
            O.hasOwnProperty(c) &&
              (b[c] =
                'object' == typeof O[c] && null !== O[c] ? ('length' in O[c] ? O[c].slice(0) : z({}, O[c])) : O[c]);
          return b;
        }
    ...
    (L.deactivate = function() {
      var a = R(c.bridge);
      a && (a.removeAttribute('title'), (a.style.left = '0px'), (a.style.top = '-9999px'), T(1, 1)),
  ...
  L.emit = function(b) {
    ...
    if (
      ...
      'object' == typeof b && b && 'string' == typeof b.type && b.type && ((f = b.type), (g = b)),
      f)
    ) {
      ...
      if (((h = !/^(before)?copy$/.test(b.type)), b.client)) U.call(b.client, b, h);
        ...
        for (
          i = b.target && b.target !== a && O.autoActivate === !0 ? Z(b.target) : N(), j = 0, k = i.length;
          k > j;
          j++
        )
      ...
      if (d && d.length) {
        ...
        for (e = 0, f = d.length; f > e; e++)
          (h = d[e]),
            ...
            'object' == typeof h && h && 'function' == typeof h.handleEvent && ((i = h), (h = h.handleEvent)),
        ...
        case 'copy':
          ...
          (g = i.value || i.textContent || i.innerText)
            ...
            : !d['text/plain'] &&
              ...
              (a.clipboardData.clearData(), a.clipboardData.setData('text/plain', g));
          break;
        case 'aftercopy':
  ...
  (L.prototype.on = function(a, b) {
    ...
    if ('string' == typeof a && a) f = a.toLowerCase().split(/\s+/);
      ...
      for (d in a) a.hasOwnProperty(d) && 'string' == typeof d && d && 'function' == typeof a[d] && this.on(d, a[d]);
    if (f && f.length) {
      for (d = 0, e = f.length; e > d; d++)
        (a = f[d].replace(/^on/, '')), (h[a] = !0), i[a] || (i[a] = []), i[a].push(b);
  ...
  var Z = function(a) {
    ...
    if (a && 1 === a.nodeType && (b = a.zcClippingId) && i.hasOwnProperty(b) && ((c = i[b]), c && c.length))
      for (d = 0, e = c.length; e > d; d++) (f = g[c[d]].instance), f && f instanceof L && h.push(f);
    return h;
  };
