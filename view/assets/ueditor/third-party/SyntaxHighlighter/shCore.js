    ...
    sh.Highlighter.prototype = {
      ...
      getMatchesHtml: function(code, matches) {
        ...
        for (var i = 0; i < matches.length; i++) {
          ...
          result +=
            wrapLinesWithCode(code.substr(pos, match.index - pos), matchBrushName + 'plain') +
      ...
      forHtmlScript: function(regexGroup) {
        ...
        this.htmlScript = {
          ...
          code: new XRegExp(
            '(?<left>' + regexGroup.left.source + ')' + '(?<code>.*?)' + '(?<right>' + regex.end + ')',
            'sgi'
          )
        };
      }
...
(function() {
  // CommonJS
  SyntaxHighlighter =
    SyntaxHighlighter || (typeof require !== 'undefined' ? require('shCore').SyntaxHighlighter : null);
