...
(function() {
  ...
  function initTabs() {
    ...
    // linguowei modify by 2018.01.22 (删除图片管理和搜索图片tab)
    tabs[0].parentNode.removeChild(tabs[2]);
    tabs[0].parentNode.removeChild(tabs[2]);
  ...
  UploadImage.prototype = {
    ...
    initUploader: function() {
      ...
      uploader.on('uploadBeforeSend', function(file, data, header) {
        ...
        // linguowei modify in 2018.01.20
        header['Authorization'] = 'Bearer' + ' ' + sessionStorage.joys_token;
      });
