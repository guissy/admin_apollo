...
!(function() {
  !(function() {
        ...
        if ('undefined' == typeof XRegExp) {
          ...
          void 0 !== this.rootPath
            ? ((c = a.removeLastbs(this.rootPath) + '/third-party/SyntaxHighlighter/shCore.js'),
              (d = a.removeLastbs(this.rootPath) + '/third-party/SyntaxHighlighter/shCoreDefault.css'))
            ...
            a.loadFile(
              document,
              { id: 'syntaxhighlighter_js', src: c, tag: 'script', type: 'text/javascript', defer: 'defer' },
              function() {
                a.each(b, function(a) {
    ...
    UE.parse.register('table', function(a) {
      ...
      function c(b, c, e) {
        for (var f = b.rows, g = [], h = 'TH' === f[0].cells[0].tagName, i = 0, j = 0, k = f.length; j < k; j++)
          g[j] = f[j];
        var l = {
    ...
    UE.parse.register('charts', function(a) {
      ...
      function f() {
        window.jQuery
          ...
          : a.loadFile(
              document,
              { src: m + '/third-party/jquery-1.10.2.min.js', tag: 'script', type: 'text/javascript', defer: 'defer' },
              function() {
                g();
              }
            );
      ...
      function h() {
        a.loadFile(
          document,
          { src: m + '/dialogs/charts/chart.config.js', tag: 'script', type: 'text/javascript', defer: 'defer' },
          function() {
            i();
          }
        );
    ...
    UE.parse.register('list', function(a) {
      function b(b) {
        ...
        a.each(b, function(b) {
          if (b.className && /custom_/i.test(b.className)) {
            ...
            if ('dash' == f || 'dot' == f)
              a.pushItem(c, h + ' li.list-' + d[f] + '{background-image:url(' + e.liiconpath + d[f] + '.gif)}'),
                a.pushItem(
                  c,
                  h +
                    ' ul.custom_' +
              ...
              a.each(b.childNodes, function(b) {
                'LI' == b.tagName &&
                  (a.pushItem(
                    c,
                    h + ' li.list-' + d[f] + g + '{background-image:url(' + e.liiconpath + 'list-' + d[f] + g + '.gif)}'
                  ),
                  g++);
              }),
                a.pushItem(
      ...
      f.length && b.call(this, f),
        ...
        (f.length || g.length) &&
          ...
          c.push(h + ' .list-paddingleft-3{padding-left:' + 2 * this.listDefaultPaddingLeft + 'px}'),
          a.cssRule('list', h + ' ol,' + h + ' ul{margin:0;padding:0;}li{clear:both;}' + c.join('\n'), document));
    }),
    UE.parse.register('vedio', function(a) {
      ...
      if ((document.createElement('video'), document.createElement('audio'), b.length || c.length)) {
        ...
        window.videojs
          ? videojs.autoSetup()
          : (a.loadFile(document, { id: 'video_css', tag: 'link', rel: 'stylesheet', type: 'text/css', href: f }),
