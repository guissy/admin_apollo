/* WebUploader 0.1.2 */ !(function(a, b) {
  ...
  return (
        ...
        d.extend(c.prototype, {
          ...
          option: function(a, b) {
            ...
            return arguments.length > 1
              ? void (d.isPlainObject(b) && d.isPlainObject(c[a]) ? d.extend(c[a], b) : (c[a] = b))
              : a
                ? c[a]
                : c;
          },
        ...
        (this.uid = a.guid('client_')),
          ...
          (this.connectRuntime = function(b, h) {
            ...
            return (
              ...
              (f = f || e.get(null, d)),
              f
                ? (a.$.extend(f.options, b), f.__promise.then(g.resolve), f.__client++)
        ...
        e.extend(b.prototype, {
          ...
          request: function(b, d, e) {
            var f,
              ...
              o = [];
            for (d = c(d) ? d : [d]; m > k; k++)
              (f = l[k]), (h = f.invoke(b, d)), h !== g && (a.isPromise(h) ? o.push(h) : n.push(h));
            return e || o.length
              ? ((i = a.when.apply(a, o)),
                (j = i.pipe ? 'pipe' : 'then'),
                i[j](function() {
          ...
          init: function(b) {
            if (b.dnd && 'html5' === this.request('predict-runtime-type')) {
              var e,
                ...
                h = d.extend(
                  {},
                  { disableGlobalDnd: b.disableGlobalDnd, container: b.dnd, accept: b.accept }
                );
              return (
                (e = new c(h)),
    ...
    b('widgets/filepaste', ['base', 'uploader', 'lib/filepaste', 'widgets/widget'], function(
      a,
      b,
      c
    ) {
    ...
    b('lib/file', ['base', 'lib/blob'], function(a, b) {
      function c(a, c) {
        ...
        b.apply(this, arguments),
          ...
          !f &&
            this.type &&
            ((f = /\/(jpg|jpeg|png|gif|bmp)$/i.exec(this.type) ? RegExp.$1.toLowerCase() : ''),
            (this.name += '.' + f)),
          !this.type &&
      ...
      return (
        ...
        b.inherits(c, {
          ...
          refresh: function() {
            ...
            c &&
              d &&
              a.css({ bottom: 'auto', right: 'auto', width: c + 'px', height: d + 'px' }).offset(e);
          },
          enable: function() {
    ...
    b('widgets/filepicker', ['base', 'uploader', 'lib/filepicker', 'widgets/widget'], function(
      a,
      b,
      c
    ) {
                    ...
                    d.once('complete', function() {
                      ...
                      try {
                        (a = d.getAsBlob(g.type)),
                          (c = b.size),
                          a.size < c &&
                            ((b.source = a), (b.size = a.size), b.trigger('resize', a.size, c)),
                          (b._compressed = !0),
                          f.resolve();
                      } catch (e) {
                        f.resolve();
    ...
    b('queue', ['base', 'mediator', 'file'], function(a, b, c) {
      ...
      return (
        e.extend(d.prototype, {
          ...
          getFiles: function() {
            for (
              var a, b = [].slice.call(arguments, 0), c = [], d = 0, f = this._queue.length;
              f > d;
              d++
            )
    ...
    b(
      'widgets/queue',
      ['base', 'uploader', 'queue', 'file', 'lib/file', 'runtime/client', 'widgets/widget'],
        ...
        return b.register(
          ...
          },
          {
            ...
            acceptFile: function(a) {
              var b =
                !a || a.size < 6 || (this.accept && h.exec(a.name) && !this.accept.test(a.name));
              return !b;
            },
            _addFile: function(a) {
              var b = this;
    ...
    b('widgets/upload', ['base', 'uploader', 'file', 'lib/transport', 'widgets/widget'], function(
      a,
      b,
      c,
      d
      ...
      function e(a, b) {
        for (
          var c, d = [], e = a.source, f = e.size, g = b ? Math.ceil(f / b) : 1, h = 0, i = 0;
          g > i;

        )
          (c = Math.min(b, f - h)),
            d.push({ file: a, start: h, end: b ? h + c : f, total: f, chunks: g, chunk: i++ }),
            (h += c);
        return (
          (a.blocks = d.concat()),
          (a.remaning = d.length),
              ...
              return d && d.has() && d.file.getStatus() === h.PROGRESS
                ...
                : c.runing
                  ? (!c.pending.length && c.getStats().numOfQueue && c._prepareNextFile(),
                    ...
                    (b = function(a) {
                      return a
                        ? ((d = e(a, f.chunked ? f.chunkSize : 0)), (c._act = d), d.fetch())
                        : null;
                    }),
              ...
              c &&
                ((a = b.request('before-send-file', c, function() {
                  return c.getStatus() === h.QUEUED
                    ? (b.owner.trigger('uploadStart', c), c.setStatus(h.PROGRESS), c)
                    : b._finishFile(c);
                })),
                a.done(function() {
                  var b = f.inArray(a, d);
              ...
              (b.transport = l),
                ...
                l.on('load', function() {
                  ...
                  return (a = c())
                    ...
                    : void (1 === k.remaning ? g._finishFile(k, e) : l.destroy());
                }),
                (m = f.extend(m, {
                  id: k.id,
                  name: k.name,
      ...
      return b.register('DragAndDrop', {
        ...
        _dragOverHandler: function(a) {
          ...
          return b && !d.contains(b, a.currentTarget)
            ? !1
            : (clearTimeout(this._leaveTimer), this._dragEnterHandler.call(this, a), !1);
        },
            ...
            if (!(a.byteLength < 6)) {
              ...
              if (65496 === h.getUint16(0)) {
                for (
                  ;
                  j > i &&
                  ((d = h.getUint16(i)), (d >= 65504 && 65519 >= d) || 65534 === d) &&
      ...
      function a(a) {
        ...
        function e() {
          for (var a = 1, b = 2, c = 1; 15 >= c; c++) {
            for (var d = a; b > d; d++)
              (E[32767 + d] = c), (D[32767 + d] = []), (D[32767 + d][1] = c), (D[32767 + d][0] = d);
            for (var e = -(b - 1); -a >= e; e++)
              (E[32767 + e] = c),
                (D[32767 + e] = []),
                (D[32767 + e][1] = c),
        ...
        (this.encode = function(a, b) {
          ...
          for (
            var f, h, j, q, s, x, y, z, A, D = a.data, E = a.width, F = a.height, G = 4 * E, N = 0;
            F > N;
            ...
            for (f = 0; G > f; ) {
              for (s = G * N + f, x = s, y = -1, z = 0, A = 0; 64 > A; A++)
                (z = A >> 3),
                  ...
                  (L[A] =
                    ((O[(h + 768) >> 0] + O[(j + 1024) >> 0] + O[(q + 1280) >> 0]) >> 16) - 128),
                  (M[A] =
                    ((O[(h + 1280) >> 0] + O[(j + 1536) >> 0] + O[(q + 1792) >> 0]) >> 16) - 128);
    ...
    b('runtime/html5/image', ['base', 'runtime/html5/runtime', 'runtime/html5/util'], function(
      a,
      b,
      c
    ) {
        ...
        _renderImageToCanvas: (function() {
          function b(a, b, c) {
            var d,
              ...
              k = c;
            for (
              g.width = 1, g.height = c, h.drawImage(a, 0, 0), d = h.getImageData(0, 0, 1, c).data;
              k > i;
    ...
    b('runtime/flash/transport', ['base', 'runtime/flash/runtime', 'runtime/client'], function(
      a,
      b,
      c
    ) {
