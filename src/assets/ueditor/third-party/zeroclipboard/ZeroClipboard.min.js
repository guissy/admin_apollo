...
!(function(a) {
  ...
  var b,
    ...
    j = (function() {
      ...
      return (
        d && ((d = d.split('#')[0].split('?')[0]), (e = d.slice(0, d.lastIndexOf('/') + 1) + e)), e
      );
    })(),
    k = (function() {
      var a = /\-([a-z])/g,
    ...
    l = function(b, c) {
      ...
      return (
        ...
        'cursor' !== c || (d && 'auto' !== d) || ((f = b.tagName.toLowerCase()), 'a' !== f)
          ? d
          : 'pointer'
      );
    },
  ...
  L.emit = function(b) {
    ...
    if (
      ...
      if (((h = !/^(before)?copy$/.test(b.type)), b.client)) U.call(b.client, b, h);
        ...
        for (
          i = b.target && b.target !== a && O.autoActivate === !0 ? Z(b.target) : N(),
            j = 0,
            k = i.length;
          k > j;
          j++
      ...
      for (var e = a.length; e--; )
        if (a.hasOwnProperty(e) && a[e] && 1 === a[e].nodeType) {
          ...
          if (f) {
            ...
            0 === f.length &&
              (O.autoActivate === !0 && o(a[e], 'mouseover', m), delete a[e].zcClippingId);
          }
        }
      return this;
    }),
