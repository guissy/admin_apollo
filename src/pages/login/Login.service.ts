...
export async function loginAjax(params: object) {
  return request(`/admin/login/one`, {
    method: 'POST',
...
export async function loginTwoAjax(params: object) {
...
export function transformLoginRoute(loginRoute: MenuItem[]) {
  ...
  const oldNewMap = {
    ...
    '/resourcesManagement': '/resourceManage',
    '/currencySettings': '/currencySetting',
    '/otherGamesAccounts': '/gameAccount',
    '/emailSettings': '/emailSetting',
    '/ckManage': '/floatAd',
    '/fieldSettings': '/systemSetting',
    '/operationLog': '/memberLog',
    '/sysLog': '/backgroundLog',
    '/domainNameSet': '/domainSetting',
    '/ADList': '/adList',
    '/ADHome': '/adHome',
    '/offlineReceipts': '/offlineReceipt',
    '/onlineReceipts': '/onlineReceipt',
    '/promotionalResources': '/promotionResource',
    '/msgManagement': '/noticeManage'
  };
